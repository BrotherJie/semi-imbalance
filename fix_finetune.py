...
def main():
    ...
    if args.dataset == 'svhn':
        train_labeled_set, train_unlabeled_set, test_set = dataset.get_SVHN('../datasets', N_SAMPLES_PER_CLASS,
                                                                            U_SAMPLES_PER_CLASS)
    else:
        train_labeled_set, train_unlabeled_set, test_set = dataset.get_cifar('../datasets', N_SAMPLES_PER_CLASS, U_SAMPLES_PER_CLASS)
